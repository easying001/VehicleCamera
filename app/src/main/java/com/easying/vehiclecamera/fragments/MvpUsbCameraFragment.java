...
import com.easying.vehiclecamera.presenters.MvpUsbCameraPresenter;
...
public class MvpUsbCameraFragment extends MvpFragment<MvpUsbCameraPresenter> implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LogUtils.tag("Fragment-Camera").d("preseter = " + presenter + ", attachView = " + presenter.getView());
        //presenter.init();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LogUtils.tag("Fragment-Camera").d("onCreateView()");
