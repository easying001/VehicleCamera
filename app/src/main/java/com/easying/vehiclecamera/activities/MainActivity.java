...
import com.easying.vehiclecamera.presenters.MvpMainActivityPresenter;
...
public class MainActivity extends MvpActivity<MvpMainActivityPresenter> implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Enable logging and set prefix
        LogUtils.getLogConfig().configAllowLog(true)
                .configTagPrefix("VehicleCamera-")
                .configShowBorders(false)
                .configLevel(LogLevel.TYPE_VERBOSE);

        LogUtils.tag("Activity-Main").d("onCreate");
    ...
    protected void onStop() {
        super.onStop();
        LogUtils.tag("Activity-Main").d("onStop");
    }

    @Override
    protected void onPause() {
        super.onPause();
        LogUtils.tag("Activity-Main").d("onPause");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        LogUtils.tag("Activity-Main").d("onDestroy");
    }

    @Override
    protected void onResume() {
        super.onResume();
        LogUtils.tag("Activity-Main").d("onResume");
    }
    ...
    private class MediaMountedBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_MEDIA_MOUNTED)) {
                ...
                LogUtils.tag("Storage").d("write usb storage path to file = " + mUsbRootPath);
            }
        }
    }
}
